...
use App\Builders\Cdek\QueryBuilder;
use App\Builders\Cdek\ResponseBuilder;
...
class CdekJob implements ShouldQueue
{
    use Queueable;
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            $message = 'Не удалось выполнить калькуляцию по ТК ' . CompanyType::Cdek->value . ': ';
