...
use App\Builders\Pochta\QueryBuilder;
use App\Builders\Pochta\ResponseBuilder;
...
class PochtaJob implements ShouldQueue
{
    use Queueable;
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            $message = 'Не удалось выполнить калькуляцию по ТК ' . CompanyType::Pochta->value . ': ';
