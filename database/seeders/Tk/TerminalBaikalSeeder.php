...
class TerminalBaikalSeeder extends Seeder
{
    /**
     * Особенности:
     * список не содержит принадлежности к стране,
     * всего 140 терминалов в основных населённых пунктах,
     * парсинг только наименования локации, без территориальной принадлежности,
     * поскольку на этой выборке появление одноимённых локаций исключено,
     * основное назначение этого списка - регистрация собственных идентификаторов,
     */
