...
class TerminalPekSeeder extends Seeder
{
    ...
    /**
     * Особенности:
     * у данной тк всего 17 почтовых индексов на 235 территориальных ветвей,
     * сложный список, построенный по типу реляционной базы данных,
     * с ним огромное количество возьни, а пользы немного,
     * поэтому после парсинга он подходит лишь для регистрации собственных идентификаторов в системе,
     * а весь парсинг нужен лишь для правильной интерпретации локаций
     */
